...
import { View, StyleSheet, Platform, StatusBar, TextInput, TouchableOpacity, Text, Dimensions} from 'react-native'
    ...
    <KeyboardAvoidingWrapper>
      <StyledContainerFullScreen>
        ...
        <Animatable.View style={styles.footer} animation="fadeInUpBig">
          <StyledFormArea>
            <SignInTextFooter style={{marginTop: 0}}>New Password</SignInTextFooter>
            <SignInAction>
